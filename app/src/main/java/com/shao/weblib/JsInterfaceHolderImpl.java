...
public class JsInterfaceHolderImpl extends JsBaseInterfaceHolder {
	...
	static JsInterfaceHolderImpl getJsInterfaceHolder(WebView webView, WebUtils.SecurityType securityType) {

		return new JsInterfaceHolderImpl(webView, securityType);
	}


	JsInterfaceHolderImpl(WebView webView, WebUtils.SecurityType securityType) {
		super(securityType);
