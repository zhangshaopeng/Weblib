...
/**
 * Description:webView 工具类开发用
 * Company:
 * Author:Zhangshaopeng
 * Email :1377785991@qq.com
 * Data:2018/6/15  Thanks for：https://github.com/Justson/AgentWeb
 */
...
public final class WebUtils {
     ...
     * WebUtils
     */
    private WebUtils mAgentWeb = null;
    /**
    ...
    private WebUtils(AgentBuilder agentBuilder) {
    ...
    public static class PreAgentWeb {
        ...
        public WebUtils go(@Nullable String url) {
            if (!isReady) {
                ready();
            }
    ...
    private WebUtils go(String url) {
    ...
    public static final class AgentBuilder {
        ...
        public AgentBuilder(@NonNull Activity activity, @NonNull Fragment fragment) {
            mActivity = activity;
            mFragment = fragment;
            mTag = WebUtils.FRAGMENT_TAG;
        }

        public AgentBuilder(@NonNull Activity activity) {
            mActivity = activity;
            mTag = WebUtils.ACTIVITY_TAG;
        }
        ...
        private PreAgentWeb buildAgentWeb() {
            if (mTag == WebUtils.FRAGMENT_TAG && this.mViewGroup == null) {
                throw new NullPointerException("ViewGroup is null,Please check your parameters .");
            }
            return new PreAgentWeb(HookManager.hookAgentWeb(new WebUtils(this), this));
        }
    ...
    public static class IndicatorBuilder {
        ...
        public CommonBuilder defaultProgressBarColor() {
